       ...
       foreach($chunk as $row)  
        {  
          ...
          <tr>  
            ...
            <td><button type="button" class="btn btn-sm btn-primary single_leave_req" data-toggle="modal" data-target="#myModal" value="<?php echo $row->leave_from.'|'.$row->leave_to.'|'.$row->leave_days.'|'.$row->description.'|'.$row->req_id.'|'.$row->emp_id;?>" >View</button></td>
          </tr>
        <?php }
       }        
        ?>  
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <?php echo form_open('Leavemanagement/leave_req_grant')?>
            ...
            <div class="form-group ">
              ...
              <div class="form-row">
                <div class="col-md-12">
                  <div class="form-label-group">
                    <?php echo form_textarea(array('name' => 'leaveDescripton','id' => 'leaveDescripton','value'=>set_value('leaveDescripton'),'class'=>'form-control'));?>
        ...
        <div class="modal-footer">
          <button class="btn btn-primary" style="float: right" type="submit">Grant</button>
